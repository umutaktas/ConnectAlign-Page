      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto items-center">
          {text.plans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-gray-900 px-4 py-1.5 rounded-full text-sm font-bold shadow-lg flex items-center">
                  <Star className="w-4 h-4 mr-1 text-yellow-700"/> {language === 'tr' ? 'POPÜLER' : 'POPULAR'}
                </div>
              )}
